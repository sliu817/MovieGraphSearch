	  ...
	  */
	  ...
	  protected Movie processLine(String aLine){
	    ...
	    if ( scanner.hasNext() ){
	      ...
	      String spanishTitle = scanner.next();
	      String imdbPictureURL = scanner.next();
	      String year = scanner.next();
	      return new Movie(Integer.valueOf(movieId), title, imdbPictureURL, year);
	    }
	    else {
	  ...
	  public static void main(String[]args) throws FileNotFoundException{
		  	MovieReader mr = new MovieReader("database/data/movies.dat");
		  	List<Movie> list = mr.processLineByLine();
		  	for(Movie m : list){
