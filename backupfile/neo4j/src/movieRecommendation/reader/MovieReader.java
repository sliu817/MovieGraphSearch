...
public class MovieReader {
	  ...
	  private ArrayList<String> GENERAS;
	...
	/**
	  ...
	  */
	  public MovieReader(String aFileName){
	    ...
	    GENERAS= new ArrayList<String>();
	    GENERAS.add("Action");
	    GENERAS.add("Adventure");
	    GENERAS.add("Animation");
	    GENERAS.add("Children's");
	    GENERAS.add("Comedy");
	    
	    GENERAS.add("Crime");
	    GENERAS.add("Documentary");
	    GENERAS.add("Drama");
	    GENERAS.add("Fantasy");
	    GENERAS.add("Film-Noir");
	    
	    GENERAS.add("Horror");
	    GENERAS.add("Musical");
	    GENERAS.add("Mystery");
	    GENERAS.add("Sci-Fi");
	    GENERAS.add("Thriller");
	  ...
	  public ArrayList<String> getGeneras(){
		  return GENERAS;
	  }
